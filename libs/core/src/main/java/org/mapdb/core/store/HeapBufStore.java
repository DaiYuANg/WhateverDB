...
import org.mapdb.core.exception.DBException;
import org.mapdb.core.io.DataInput2ByteArray;
...
public class HeapBufStore implements Store {
    ...
    @Override
    public <K> long put(@NotNull K record, @NotNull Serializer<K> serializer) {
        byte[] data = serialize(serializer, record);
