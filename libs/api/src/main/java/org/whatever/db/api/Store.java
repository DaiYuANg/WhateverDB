...
public interface Store extends ReadonlyStore {
  ...
  @NotNull
  default <R> R getAndUpdate(long recid, @NotNull Serializer<R> serializer, @NotNull R updatedRecord) {
  ...
  interface Transform<R> {
    @NotNull
    R transform(@NotNull R r);
  }

  @NotNull
  default <R> R updateAndGet(long recid, @NotNull Serializer<R> serializer, @NotNull Transform<R> t) {
    R old = get(recid, serializer);
  ...
  @NotNull
  default <R> R getAndUpdateAtomic(long recid, @NotNull Serializer<R> serializer, @NotNull Transform<R> t) {
    R old = get(recid, serializer);
    R newRec = t.transform(old);
    update(recid, serializer, newRec);
    return old; //TODO atomic
  ...
  @NotNull
  <R> R getAndDelete(long recid, @NotNull Serializer<R> serializer);
